...
def main():
    ...
    track_sequences_classifier = TrackSequencesClassifier(
        os.path.join(config['MODELS_PATH'], VIDEO_SEQUENCE_MODEL_WEIGHTS_PATH))
    track_faces_classifier = TrackFacesClassifier(
        os.path.join(config['MODELS_PATH'], FIRST_VIDEO_FACE_MODEL_WEIGHTS_PATH),
